...
var nicEditorPane = bkClass.extend({
	construct : function(elm,nicEditor,options,openButton) {
		...
		this.pane = new bkElement('div').setStyle({fontSize : '12px', border : '0px solid #ccc', 'overflow': 'hidden', padding : '4px', textAlign: 'left', backgroundColor : '#2588d0'}).addClass('pane').setStyle(options).appendTo(this.contain);
